  ...
  render() {
    return (  
      ...
      <header className="footer-header sticky-top py-1">
        <nav id="navbar" className="container d-flex flex-column flex-md-row justify-content-between">
      ...
      <main>
        ...
        <div id="About" className="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
          <div className="card splash-height bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white">
          ...
          <div className="card splash-height bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 overflow-hidden">
        ...
        <div id="Consultation" className="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
          <div className="card splash-height bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 overflow-hidden">
            <div className="my-3 p-3">
              <p className="">
          ...
          <div className="card splash-height bg-primary me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
            <div className="my-3 py-3">
        ...
        <div id="Book" className="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
          <div className="book card splash-height me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center">
          </div>
          <div className="card splash-height bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5">
            <div className="my-3 p-3">
              <p className="lead">
                Book
              </p>
        ...
        <div id="Presentation" className="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
          <div className="card splash-height bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 overflow-hidden">
            <div className="my-3 p-3">
              <p className="lead">
                Presentation
          ...
          <div className="preso card splash-height me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center">
          </div>
        </div>
        ...
        <div className="container py-3">
          <div className="row">
            <div className="col-12 col-md">
              ...
              <small className="d-block mb-3 text-muted">© Peter Kwon CPA, 2020</small>
            </div>
